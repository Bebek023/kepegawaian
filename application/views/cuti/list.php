    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="<?php echo site_url(); ?>/cuti">Cuti<span class="sr-only">(current)</a>
        </li>
        <li class="nav-item">
      ...
      <table class="table table-hover">
        <thead align="center">
          <tr>
            ...
            <th scope="col">Tanggal mulai cuti
            <th scope="col">Tanggal selesai cuti
            <th scope="col">
          </tr>
        </thead>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <a class="btn btn-danger" href="<?php echo site_url() ?>/cuti/delete?id=<?php echo $value->id ?>" role="button">Hapus</a>
